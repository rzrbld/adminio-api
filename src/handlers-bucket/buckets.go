...
var ListExtended = func(ctx iris.Context) {
	lb, err := minioClnt.ListBuckets()
...
var Make = func(ctx iris.Context) {
...
var GetLifecycle = func(ctx iris.Context) {
	var bucketName = ctx.FormValue("bucketName")
...
var SetLifecycle = func(ctx iris.Context) {
	var bucketName = ctx.FormValue("bucketName")
...
var GetEvents = func(ctx iris.Context) {
...
var SetEvents = func(ctx iris.Context) {
...
var RemoveEvents = func(ctx iris.Context) {
	var bucket = ctx.FormValue("bucket")
